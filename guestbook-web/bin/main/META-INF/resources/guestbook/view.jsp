...
<aui:form action="${searchURL}" name="fm">
    ...
    <div class="row">
        <div class="col-md-11">
            <aui:input inlineLabel="left" label="" name="keywords" placeholder="search-entries" size="300" />
        </div>
...
<liferay-ui:search-container total="<%=GuestbookEntryLocalServiceUtil.
	...
	<liferay-ui:search-container-row className="guestbook.model.GuestbookEntry" modelVar="entry">
