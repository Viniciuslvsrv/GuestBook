...
public class GuestbookEntryAssetRenderer extends BaseJSPAssetRenderer<GuestbookEntry> {
    ...
    public PortletURL getURLEdit(LiferayPortletRequest liferayPortletRequest,
        ...
        PortletURL portletURL = liferayPortletResponse.createLiferayPortletURL(
            getControlPanelPlid(liferayPortletRequest), GuestbookConstants.GUESTBOOKWEB,
    ...
    public String getURLViewInContext(LiferayPortletRequest liferayPortletRequest,
        ...
        try {
            long plid = PortalUtil.getPlidFromPortletId(_entry.getGroupId(),
            		GuestbookConstants.GUESTBOOKWEB);
            ...
            if (plid == LayoutConstants.DEFAULT_PLID) {
                ...
                portletURL = PortletURLFactoryUtil.create(liferayPortletRequest,
                		GuestbookConstants.GUESTBOOKWEB, plid, PortletRequest.RENDER_PHASE);
            }
