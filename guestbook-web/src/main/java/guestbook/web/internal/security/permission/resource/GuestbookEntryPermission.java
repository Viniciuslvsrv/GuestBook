package guestbook.web.internal.security.permission.resource;
...
public class GuestbookEntryPermission {
    ...
    public static boolean contains(PermissionChecker permissionChecker, 
    		   GuestbookEntry entry, String actionId) throws PortalException {
    ...
    @Reference(
        target = "(model.class.name=guestbook.model.GuestbookEntry)", 
        unbind = "-"
    )
