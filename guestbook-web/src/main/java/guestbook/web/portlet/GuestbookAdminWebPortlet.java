...
@Component(
    ...
    property = {
            ...
            "javax.portlet.name=" + GuestbookConstants.GUESTBOOK_ADMIN,
...
public class GuestbookAdminWebPortlet extends MVCPortlet {
	...
	public void addGuestbook(ActionRequest request, ActionResponse response)
	    ...
	    try {
	        ...
	        response.setRenderParameter("mvcPath", "/guestbook_admin/edit_guestbook_admin.jsp");
	    }
	}
	...
	public void updateGuestbook(ActionRequest request, ActionResponse response)
	    ...
	    try {
	        ...
	        response.setRenderParameter(
	            "mvcPath", "/guestbook_admin/edit_guestbook_admin.jsp");
	    }
	}
